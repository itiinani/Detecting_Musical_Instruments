...
if __name__ == '__main__':
    ...
    files = glob.glob('../MISDataset/gui/*.aif')
    count=0
    for filename in files:
        filenameNew = filename[18:]
        print filenameNew
        # Preprocess the music file to get features from it
        if 'Cel' in filenameNew[0:3]:
            instrument_code = 17
        elif 'Flu' in filenameNew[0:3] or 'Flu' in filenameNew[4:7]:
            instrument_code = 33
        elif 'ban' in filenameNew[0:3]:
            instrument_code = 36
        elif 'Cla' in filenameNew[4:7] or 'Cla' in filenameNew[2:5]:
            instrument_code = 31
        elif 'Gui' in filenameNew[0:3]:
            instrument_code = 9
        elif 'man' in filenameNew[0:3]:
            instrument_code = 12
        elif 'Sax' in filenameNew[3:6] or 'Sax' in filenameNew[4:7]:
            instrument_code = 25
        elif 'Tru' in filenameNew[0:3]:
            instrument_code = 21
        elif 'Vio' in filenameNew[0:3]:
            instrument_code = 15
        elif 'Pia' in filenameNew[0:3]:
            instrument_code = 1
        else:
            instrument_code = 0
    ...
    filename = 'Datasets/TrainingData/mis_features_gui.csv'
